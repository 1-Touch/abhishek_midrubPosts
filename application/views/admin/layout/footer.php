...
<!--custom added js-->
<script src="<?php echo base_url(); ?>assets/custom/js/common.min.js"></script>
    <script src="<?php echo base_url(); ?>assets/custom/js/custom.min.js"></script>
    <script src="<?php echo base_url(); ?>assets/custom/js/settings.js"></script>
    <script src="<?php echo base_url(); ?>assets/custom/js/gleek.js"></script>
    <script src="<?php echo base_url(); ?>assets/custom/js/styleSwitcher.js"></script>

    <script src="<?php echo base_url(); ?>assets/custom/js/dashboard/dashboard-1.js"></script>
    <!-- <script src="<?php echo base_url(); ?>assets/custom/plugins/flot/js/jquery.flot.min.js"></script>
    <script src="<?php echo base_url(); ?>assets/custom/plugins/flot/js/jquery.flot.pie.js"></script>
    <script src="<?php echo base_url(); ?>assets/custom/plugins/flot/js/jquery.flot.resize.js"></script>
    <script src="<?php echo base_url(); ?>assets/custom/plugins/flot/js/jquery.flot.spline.js"></script>
    <script src="<?php echo base_url(); ?>assets/custom/plugins/flot/js/jquery.flot.init.js"></script> -->
    
    <!-- <script src="<?php echo base_url(); ?>assets/js/Chart.bundle.min.js"></script> -->
	
	<!-- <script src="<?php echo base_url(); ?>assets/custom/plugins/chartist/js/chartist.min.js"></script>
    <script src="<?php echo base_url(); ?>assets/custom/plugins/chartist-plugin-tooltips/js/chartist-plugin-tooltip.min.js"></script>
    <script src="<?php echo base_url(); ?>assets/custom/js/plugins-init/chartist.init.js"></script> -->
