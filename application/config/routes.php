...
//migration route
$route['migrate'] = 'migrate';//custom

// Admin routes
$route['admin/home'] = 'adminarea/dashboard';
$route['admin/notifications'] = 'adminarea/notifications';
$route['admin/users'] = 'adminarea/users';
$route['admin/instagram'] = 'adminarea/instagram';//custom
$route['admin/instagramuserajax']['post'] = 'adminarea/instagram_user_ajax';//custom
$route['admin/instagram/(:any)'] = 'adminarea/instagram_user/$1';//custom
